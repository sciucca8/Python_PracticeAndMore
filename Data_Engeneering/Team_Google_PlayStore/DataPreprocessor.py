...
class DataPreprocessor:
    ...
    def pipeline(self, df, copy: bool = False):
        ...
        self.content_rating_cleaning(df)
    ...
    def content_rating_cleaning(self, df):
        df = df.reset_index()
        ...
        df = df.rename(columns= {"Content Rating": "Age Restriction"})
        df["Age Restriction"] = df["Age Restriction"].astype(int)
        return df    
